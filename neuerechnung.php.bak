          ...
          <!--                     <span>1</span> -->
                                   ...
                                   <div class="row">
                                        ...
                                        ?>
                                                  <span class="invoice_item" id="item_1">
                                                       ...
                                                       <p class="_20">
                                                            <input style="text-align:right;" class="price_total" type="text" disabled value="0€" />
                                                       </p>
                                                  </span>
                                        <?php
                                             } else {
                                        ...
                                        <p class="_20">
                                             <input style="text-align:right;" type="text" class="subtotal" disabled value="0€" />
                                        </p>
                                        <!-- Shipping -->	
                                        <p class="_10">
                                             &nbsp;
                                        ...
                                        <p class="_20">
                                             <input style="text-align:right; background-color:lightgreen;" type="text" class="grand_total" name="grand_total" disabled value="0€" />
                                        </p>							
                                   </div>
               ...
               $( "#add_new_item" ).live('click', function(e){
                    ...
                    var html = '<span class="invoice_item" id="item_'+id+'">'+
                                   ...
                                   '</p>'+
                                   '<p class="_20">'+
                                        '<input style="text-align:right;" type="text" class="price_total" disabled value="0€" />'+
                                   '</p>'+
                              '</span>';
