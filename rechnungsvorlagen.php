<?php
	...
	$userData = mysql_fetch_assoc($userData);	 
     $sql = "SELECT * FROM invoice_template WHERE iId = 1";
...
?></span></a>
                        ...
                        <li class="current">
                            ...
                            <ul>
								<li class="current"><a href="rechnungsvorlagen.php"><span class="icon"><img src="img/icons/packs/fugue/16x16/blue-document-pdf-text.png" alt="" height=16 width=16></span>Rechnungsvorlage</a></li>
