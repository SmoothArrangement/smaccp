				...
				<div class="box">
					...
					<div class="content">
						...
						<table class="dynamic styled" data-filter-Bar="always">
							<thead>
								<tr>
									<th style="width: 150px;">Rechnungsnummer</th>
									<th style="width: 150px;">Kundennummer</th>
									<th style="width: 150px;">Kunde</th>
									<th style="width: 150px;">Rechnungsbetrag</th>
									<th style="width: 150px;">Rechnungsstatus</th>
									<th style="width: 150px;">Optionen</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td class="center">SMA-R4980-1</td>
									<td class="center">SMA-K4980-1</td>
									<td class="center">Philipp Dallmann</td>
									<td class="center">19,95€</td>
									<td class="center">							<select>
								<option value="Unbezahlt">Offen</option> 
								<option value="Bezahlt">Bezahlt</option> 
								<option value="Bezahlt">Mahnlauf aussetzen</option> 
								<option value="Bezahlt">Inkasso</option> 
							</select></td>
									<td class="center">
									<a title="Eintrag löschen" href="#"><span class="icon"><img src="img/icons/packs/fugue/16x16/cross-script.png" alt="" height=16 width=16>
									<a title="Eintrag bearbeiten" href="#"><span class="icon"><img src="img/icons/packs/fugue/16x16/pencil.png" alt="" height=16 width=16>
									<a title="Eintrag ansehen" href="#"><span class="icon"><img src="img/icons/packs/fugue/16x16/eye.png" alt="" height=16 width=16>
									</td>
								</tr>
								<tr>
									<td class="center">SMA-R4980-2</td>
									<td class="center">SMA-K4980-2</td>
									<td class="center">Yash Amipara</td>
									<td class="center">199,95€</td>
									<td class="center">							<select>
								<option value="Unbezahlt">Bezahlt</option> 
								<option value="Bezahlt">Offen</option>
								<option value="Bezahlt">Mahnlauf aussetzen</option> 								
								<option value="Bezahlt">Inkasso</option> 
							</select></td>
									<td class="center">
								...
								<tr>
									<td class="center">SMA-R4980-3</td>
									<td class="center">SMA-K4980-1</td>
									<td class="center">Philipp Dallmann</td>
									<td class="center">79,95€</td>
									<td class="center">							<select>
								<option value="Unbezahlt">Mahnlauf aussetzen</option> 
								<option value="Bezahlt">Offen</option>
								<option value="Bezahlt">Bezahlt</option> 								
								<option value="Bezahlt">Inkasso</option> 
							</select></td>
