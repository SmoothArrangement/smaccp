                ...
                <div class="top">
                    ...
                    <nav><ul class="collapsible accordion">
                            ...
                            <li class="current">
                                ...
                                <ul>
                                    <li class="current"><a href="alletickets.php"><span class="icon"><img src="img/icons/packs/fugue/16x16/mails-stack.png" alt="" height=16 width=16></span>Alle Tickets</a></li>
                                    ...
                                    for ($i = 0; $i < count($data); $i++) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="neuesticket.php?tid=<?= $data[$i]['iId'] ?>"><span class="icon"><img src="img/icons/packs/fugue/16x16/pencil.png" alt="Ticket bearbeiten" title="Ticket bearbeiten" height=16 width=16></span></a>&nbsp;
                                                <a href="alletickets.php?did=<?= base64_encode($data[$i]['iId']) ?>"><span class="icon"><img src="img/icons/packs/fugue/16x16/cross-circle-frame.png" alt="Ticket l&ouml;schen" title="Ticket l&ouml;schen" height=16 width=16></span></a>&nbsp;
                                            </td>
                                        </tr>
                                        <?php
                                    }
