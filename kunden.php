            ...
            <aside>
                <div class="top">
                    ...
                    <nav><ul class="collapsible accordion">
                            ...
                            <li class="current">
                                <a class="open" href="javascript:void(0);"><img src="img/icons/packs/fugue/16x16/users.png" alt="" height=16 width=16>Kunden<span class="badge"><?php
                                        $sql = "SELECT * FROM `user_mst` ";
                                        $invoice = mysql_query($sql);
                                        echo mysql_num_rows($invoice) - 1;
                                        ?></span></a>
                                <ul>
                                    <li class="current"><a href="kunden.php"><span class="icon"><img src="img/icons/packs/fugue/16x16/user-share.png" alt="" height=16 width=16></span>Kundenübersicht</a></li>
                                                                ...
                                                                <a class="dialog_normal_btn" href="javascript:void(0);"><span class="icon"><img src="img/icons/packs/fugue/16x16/eye.png" alt="" height=16 width=16></a>
                                                                    ...
                                                                    <script>
                                                                        $$.ready(function () {
                                                                            ...
                                                                            $("#change_image").live('click', function (e) {
                                                                                $('#profile').trigger('click');
                                                                            });
                                                                            $('#profile').live('change', function (e) {
                                                                                 $("#change_image_form").submit();
                                                                            });
                                                                            $('#change_image_form').live('submit', function (e) {
                                                                                     $.ajax( {
                                                                                          url: 'ajax_save.php',
                                                                                          type: 'POST',
                                                                                        ...
                                                                                        if (msg !== 'No') {
                                                                                            $('.uProfile_image').attr('src', 'img/elements/profile/'+msg);
                                                                                        } else {
                                                                                            alert("Try Again");
                                                                                        }
                                                                                    });
