<?php
     ...
     $c_id = mysql_real_escape_string(base64_decode($_REQUEST['id']));
     $cust_sql = "SELECT * FROM user_mst WHERE iId='" . $c_id . "';";
     ...
     if (isset($_REQUEST['send'])) {
          ...
          $old_email = mysql_real_escape_string($_REQUEST['old_email']);
          if($email == $old_email){
               $count_email = 0;
          } else {
               $checkemail = "SELECT * FROM user_mst WHERE vEmail='" . $email . "'";
               $emailresult = mysql_query($checkemail);
               $count_email = mysql_num_rows($emailresult);
          }
          ...
          if ($count_email == 0) {
               ...
               $up_query = "UPDATE `user_mst` SET `vFname`='" . $fname . "', `vLname`='" . $lname . "', `vEmail`='" . $email . "', `vSolution`='" . $solution . "', `vCompany`='" . $company . "', `vUstid`='" . $ustid . "', `vRoad`='" . $road . "', `vHouseNumber`='" . $h_number . "', `vZip`='" . $zip . "', `vPlace`='" . $place . "', `vCountry`='" . $country . "', `vPhone`='" . $phone . "', `vFax`='" . $fax . "', `vInternet`='" . $internet . "', `vAccountHolder`='" . $acholder . "', `vSepa`='" . $sepa . "', `dSepaDate`='" . $sepadate . "', `vIBan`='" . $iban . "', `vBic`='" . $bic . "', `tDescription`='" . $other_info . "', `vStatus`='" . $status . "' WHERE iId='".$customer_id."'";
...
?></span></a>
                              ...
                              <div class="content">
                                   ...
                                   <div class="row">
                                        ...
                                        <p class="_25">
                                             ...
                                             <select style="height:150px;" data-placeholder="Anrede" class="search" name="solution" >
                                                  ...
                                                  while ($row = mysql_fetch_assoc($salutation)) {
                                                       $selected = "";
                                                       if($cust_info['vSolution'] == $row['iId']){
                                                            $selected = "selected='selected'";
                                                       }
                                                  ?>
                                                       <option value="<?= $row['iId'] ?>" <?=$selected?>><?= $row['vSalutation'] ?></option>
                                                  <?php
                                                  }
                                                  ?>
                                             </select>
                                        ...
                                        <p class="_25">
                                             ...
                                             <input type="hidden" name="customer_id" value="<?= $cust_info['iId'] ?>"/>
                                             <input type="text" name="customer_number" readonly="true" value="<?= $cust_info['vCustomerNumber'] ?>"/>
                                        </p>							
                                        <p style="height:0; margin:0;" class="_100"></p>						
                                        <p class="_75">
                                             <label>Firma</label>							
                                             <input type="text" name="company" value="<?= $cust_info['vCompany'] ?>" />
                                        </p>
                                        <p class="_25">
                                             <label>UStId</label>							
                                             <input type="text" name="ustid" value="<?= $cust_info['vUstid'] ?>" />
                                        </p>
                                        <p class="_50">
                                             <label>Vorname</label>							
                                             <input type="text" name="fname" value="<?= $cust_info['vFname'] ?>" />
                                        </p>
                                        <p class="_50">
                                             <label>Name</label>							
                                             <input type="text" name="name" value="<?= $cust_info['vLname'] ?>" />
                                        </p>

                                        <p class="_80">
                                             <label>Straße</label>
                                             <input type="text" name="road" value="<?= $cust_info['vRoad'] ?>" />
                                        </p>
                                        <p class="_20">
                                             <label>Hausnummer</label>
                                             <input type="text" name="h_number" value="<?= $cust_info['vHouseNumber'] ?>" />
                                        </p>

                                        <p class="_20">
                                             <label>PLZ</label>
                                             <input type="text" name="zip" value="<?= $cust_info['vZip'] ?>" />
                                        </p>
                                        <p class="_30">
                                             <label>Ort</label>
                                             <input type="text" name="place" value="<?= $cust_info['vPlace'] ?>" />
                                        </p>
                                        <p class="_50">
                                             <label>Land</label>
                                             <select style="height:150px;" data-placeholder="Land" class="search" name="country" >
                                                  ...
                                                  while ($row = mysql_fetch_assoc($country_mst)) {
                                                       $selected = "";
                                                       if($cust_info['vCountry'] == $row['iId']){
                                                            $selected = "selected='selected'";
                                                       }
                                                  ?>
                                                       <option value="<?= $row['iId'] ?>" <?=$selected?>><?= $row['vCountry'] ?></option>
                                                  <?php
                                                  }
                                                  ?>
                                             </select>
                                   ...
                                   <div class="row">
                                        ...
                                        <p class="_25">
                                             <label>Telefon</label>
                                             <input type="text" name="phone" value="<?= $cust_info['vPhone'] ?>" />
                                        </p>
                                        <p class="_25">
                                             <label>Fax</label>
                                             <input type="text" name="fax" value="<?= $cust_info['vFax'] ?>" />
                                        </p>	
                                        <p class="_25">
                                             <label>E-Mail</label>
                                             <input type="email" name="email" value="<?= $cust_info['vEmail'] ?>" />
                                             <input type="hidden" name="old_email" value="<?= $cust_info['vEmail'] ?>" />
                                        </p>	
                                        <p class="_25">
                                             <label>Internet</label>
                                             <input type="text" name="internet" value="<?= $cust_info['vInternet'] ?>" />
                                        </p>								
                                   ...
                                   <div class="row">
                                        ...
                                        <p class="_50">
                                             ...
                                             <input type="text" name="acholder" value="<?= $cust_info['vAccountHolder'] ?>" />
                                        </p>

                                        <p class="_25">
                                             <label>Sepa-Mandat</label>
                                             <select style="height:150px;" data-placeholder="Land" class="search" name="sepa" >
                                                  <option value="Ja" <?php if($cust_info['vSepa'] == 'Ja'){ echo "selected='selected'";}?>>Ja</option> 
                                                  <option value="Nein" <?php if($cust_info['vSepa'] == 'Nein'){ echo "selected='selected'";}?>>Nein</option> 
                                             </select>
                                        </p>
                                        <p class="_25">
                                             <label>Mandats Datum</label>
                                             <input type="date" name="sepadate" value="<?= date('m/d/Y', strtotime($cust_info['dSepaDate'])) ?>" />
                                        </p>							
                                        <p style="height:0; margin:0;" class="_100"></p>
                                        <p class="_50">
                                             <label>IBAN</label>
                                             <input type="text" name="iban" value="<?= $cust_info['vIBan'] ?>" />
                                        </p>
                                        <p class="_50">
                                             <label>BIC</label>
                                             <input type="text" name="bic" value="<?= $cust_info['vBic'] ?>" />
                                        </p>							
                                   </div>
                                   <div class="row">
                                        ...
                                        <p class="_20">
                                             <label>&nbsp;</label>
                                             <button href="javascript:void(0);" type="button" class="button grey block send_password" data-id="<?= $cust_info['iId'] ?>"><span class="icon icon-plus"></span>Neues Passwort</button>
                                        </p>
                                        <p class="_20">
                                             <label>&nbsp;</label>
                                             <button href="javascript:void(0);" type="button" class="button grey block"><span class="icon icon-plus"></span>Zur Kundenansicht</button>
                                        </p>
                                        <p class="_20">
                                             <label style="margin-bottom:13px;">Account Status</label>
                                             <select name="status">
                                                  <option value="1" <?php if($cust_info['vStatus'] == '1'){ echo "selected='selected'";}?>>Aktiv</option>
                                                  <option value="0" <?php if($cust_info['vStatus'] == '0'){ echo "selected='selected'";}?>>Gesperrt</option>
                                             </select>
                                        </p>								
                                        <p class="_40">
                                             <label>Interne Bemerkungen</label>
                                             <textarea style="margin-top:5px; width:97%;" name="other_info"><?= $cust_info['tDescription'] ?></textarea>
                                        </p>					
                                   </div>							
                                   <div class="actions">
                                        <div class="left">
          ...
          <script>
               $$.loaded();
               $( ".send_password" ).live('click', function(e){
                    e.preventDefault();
                    var id = $(this).attr('data-id');
                    $.ajax({
                         method: "POST",
                         url: "ajax_save.php",
                         data: { type: 'send_password', id: id }
                    }).done(function( data ) {
                          alert(data);
                    });
                    return false;
