				...
				<div class="box">
					...
					<div class="content">
						...
						<table class="dynamic styled" data-filter-Bar="always">
							<thead>
								<tr>
									<th style="width: 150px;">Angebotsnummer</th>
									<th style="width: 150px;">Kundennummer</th>
									<th style="width: 150px;">Kunde</th>
									<th style="width: 150px;">Angebotsbetrag</th>
									<th style="width: 150px;">Angebotsstatus</th>
									<th style="width: 150px;">Optionen</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td class="center">SMA-A4980-1</td>
								...
								<option value="Bezahlt">Angenommen</option> 
								<option value="Bezahlt">Abgelehnt</option> 
							</select></td>
									<td class="center">
								...
								<tr>
									<td class="center">SMA-A4980-2</td>
								...
								<tr>
									<td class="center">SMA-A4980-3</td>
									<td class="center">SMA-K4980-1</td>
									<td class="center">Philipp Dallmann</td>
