...
if (isset($_REQUEST['send']) && $_REQUEST['send'] != "") {
    ...
    if(isset($_REQUEST['empfaenger']) && $_REQUEST['empfaenger'] != "") {
                        ...
                        <nav><ul class="collapsible accordion">
                                ...
                                <li class="current">
                                    ...
                                    <ul>
                                        ...
                                        <li class="current"><a href="neuesticket.php"><span class="icon"><img src="img/icons/packs/fugue/16x16/mail--plus.png" alt="" height=16 width=16></span>Neues Ticket</a></li>
