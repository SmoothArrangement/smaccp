			...
			<div class="grid_12">
				<form class="box grid">
					...
					<div class="content">
						...
						<div class="row">
						<h2 class="_100">Rechnungsdaten</h2>
							<p class="_40">
							<label>Kunde</label>
							<select style="height:150px;" data-placeholder="Bitte wählen..." class="search" >
							    <option></option>
								<option value="SMA-K4980-1 | Philipp Dallmann">SMA-K4980-1 | Philipp Dallmann</option> 
								<option value="SMA-K4980-2 | Yash Amipara">SMA-K4980-2 | Yash Amipara</option> 
							</select>
							</p>
														</p>							
							<p class="_20">
							...
							<label>Zahlungsbedingungen</label>							
								<select style="height:150px;" data-placeholder="Bitte wählen..." class="search" >
							    <option></option>
								<option value="5 Werktage ohne Abzug">5 Werktage ohne Abzug</option> 
								<option value="Lastschrifteinzug">Lastschrifteinzug</option> 
							</select>
							</p>
							<p class="_25">
							<label>Zahlungsart</label>							
								...
								<option value="SEPA-Mandat">SEPA-Mandat</option> 
							</select>
							</p>
							<p class="_50">
							...
							<div class="row">
							<h2 class="_100">Rechnungspositionen</h2>
							<p style="margin-bottom:-10px;" class="_100">
							<span class="icon"><img src="img/icons/packs/fugue/16x16/plus.png" alt="" height=16 width=16></span>
							<span class="icon"><img src="img/icons/packs/fugue/16x16/minus.png" alt="" height=16 width=16></span>
							</p>
							<p class="_10">
							<label>#</label>
							...
							<p class="_20">
							<label>Gesamt</label>
							<input style="text-align:right;" type="text" disabled value="19,95€" />
							</p>
<!-- automatic generated rows (2) -->
							<p class="_10">
							...
							<p class="_20">
							<input style="text-align:right;" type="text" disabled value="9,95€" />
							</p>
<!-- automatic generated rows (3) -->							
							<p class="_10">
							...
							<p class="_20">
							<input style="text-align:right;" type="text" disabled value="150,00€" />
							</p>
<!-- Pre Total -->	
							<p class="_10">
							&nbsp;
							...
							<p class="_20">
							<input style="text-align:right;" type="text" disabled value="179,90€" />
							</p>
<!-- Shipping -->	
							<p class="_10">
							&nbsp;
							...
							<p class="_20">
							<input style="text-align:right;" type="text" value="4,90€" />
							</p>							
<!-- TAX -->
							<p class="_10">
							&nbsp;
...
<!-- TOAL -->	
							...
							<p class="_20">
							<input style="text-align:right; background-color:lightgreen;" type="text" disabled value="184,80€" />
							</p>							
							</div>
